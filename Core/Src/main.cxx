...
void HAL_DCMI_FrameEventCallback( DCMI_HandleTypeDef *hdcmi )
{
    ...
    if ( states.nightMode )
    {
        ov2640_set_awb_gain( &gs_handle, OV2640_BOOL_FALSE );
        ov2640_set_awb( &gs_handle, OV2640_BOOL_FALSE );
        // ov2640_basic_set_light_mode( OV2640_LIGHT_MODE_HOME );
        ov2640_set_agc_gain( &gs_handle, 0 );
    }
    else
    {
